...
export const PHRASES: Phrase[] = [
  ...
  // === À la caisse — phrases à dire (15) ===
  { id: 'ca-p-01', situation: 'caisse', romaji: 'kore o kudasai.', french: 'Je prends ceci.' },
  { id: 'ca-p-02', situation: 'caisse', romaji: 'ikura desu ka?', french: 'Combien ça coûte ?' },
  { id: 'ca-p-03', situation: 'caisse', romaji: 'kaado de haraemasu ka?', french: 'Puis-je payer par carte ?' },
  { id: 'ca-p-04', situation: 'caisse', romaji: 'genkin de haraimasu.', french: 'Je paie en espèces.' },
  { id: 'ca-p-05', situation: 'caisse', romaji: 'denshi-manee de haraimasu.', french: 'Je paie en monnaie électronique.' },
  { id: 'ca-p-06', situation: 'caisse', romaji: 'fukuro o kudasai.', french: 'Un sac s\'il vous plaît.' },
  { id: 'ca-p-07', situation: 'caisse', romaji: 'fukuro wa irimasen.', french: 'Pas besoin de sac.' },
  { id: 'ca-p-08', situation: 'caisse', romaji: 'atatamete kudasai.', french: 'Pouvez-vous le chauffer ?' },
  { id: 'ca-p-09', situation: 'caisse', romaji: 'ohashi o kudasai.', french: 'Des baguettes svp.' },
  { id: 'ca-p-10', situation: 'caisse', romaji: 'reshiito wa irimasen.', french: 'Pas besoin de reçu.' },
  { id: 'ca-p-11', situation: 'caisse', romaji: 'ryoushuusho o onegaishimasu.', french: 'Une facture officielle svp.' },
  { id: 'ca-p-12', situation: 'caisse', romaji: 'pointo kaado wa motte imasen.', french: 'Je n\'ai pas de carte de fidélité.' },
  { id: 'ca-p-13', situation: 'caisse', romaji: 'waribiki wa arimasu ka?', french: 'Y a-t-il une réduction ?' },
  { id: 'ca-p-14', situation: 'caisse', romaji: 'koko de tabemasu.', french: 'Je mange sur place.' },
  { id: 'ca-p-15', situation: 'caisse', romaji: 'mochikaeri de onegaishimasu.', french: 'À emporter svp.' },

  // === À la caisse — phrases à comprendre (12) ===
  { id: 'ca-l-01', situation: 'caisse', direction: 'listen', romaji: 'irasshaimase!', french: 'Bienvenue !' },
  { id: 'ca-l-02', situation: 'caisse', direction: 'listen', romaji: 'tsugi no kata douzo.', french: 'Au suivant svp.' },
  { id: 'ca-l-03', situation: 'caisse', direction: 'listen', romaji: 'pointo kaado wa omochi desu ka?', french: 'Avez-vous une carte de fidélité ?' },
  { id: 'ca-l-04', situation: 'caisse', direction: 'listen', romaji: 'fukuro wa goriyou ni narimasu ka?', french: 'Souhaitez-vous un sac ?' },
  { id: 'ca-l-05', situation: 'caisse', direction: 'listen', romaji: 'atatamemasu ka?', french: 'Je le chauffe ?' },
  { id: 'ca-l-06', situation: 'caisse', direction: 'listen', romaji: 'ohashi wa goriyou ni narimasu ka?', french: 'Avez-vous besoin de baguettes ?' },
  { id: 'ca-l-07', situation: 'caisse', direction: 'listen', romaji: 'oshiharai wa ikaga itashimasu ka?', french: 'Comment souhaitez-vous payer ?' },
  { id: 'ca-l-08', situation: 'caisse', direction: 'listen', romaji: 'okaado de yoroshii desu ka?', french: 'Vous payez par carte ?' },
  { id: 'ca-l-09', situation: 'caisse', direction: 'listen', romaji: 'anshou-bangou o nyuuryoku kudasai.', french: 'Tapez votre code PIN svp.' },
  { id: 'ca-l-10', situation: 'caisse', direction: 'listen', romaji: 'koko de omeshiagari desu ka, omochikaeri desu ka?', french: 'Sur place ou à emporter ?' },
  { id: 'ca-l-11', situation: 'caisse', direction: 'listen', romaji: 'gohyaku-en ni narimasu.', french: 'Cela fera 500 yens.' },
  { id: 'ca-l-12', situation: 'caisse', direction: 'listen', romaji: 'otsuri to reshiito desu.', french: 'Voici votre monnaie et votre reçu.' },
];
